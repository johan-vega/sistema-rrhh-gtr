...
const MOCK_CATEGORIES: RequestCategory[] = [
  ...
  { id: 4, name: 'Justificación de falta', description: 'Justificación de una ausencia ocurrida', requires_document: true, minimum_advance_days: 0, maximum_past_days: 7, is_absence: true, active: true },
